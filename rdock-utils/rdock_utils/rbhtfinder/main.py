...
3) Run rbhtfinder, specifying -i <sdreport_file> and an arbitrary
  ...
  for calculations will be considerably slower.
    ...
    # input
    # python rdock_utils/rbhtfinder_original_copy -i tests/fixtures/rbhtfinder/input.txt -o tests/fixtures/rbhtfinder/output.txt -t tests/fixtures/rbhtfinder/threshold.txt -f column=4,steps=3,min=-10.0,max=0.0,interval=5.0 column=6,steps=5,min=1.0,max=5.0,interval=5.0 --max-time 1 --min-perc 1.0 -v 5 --header

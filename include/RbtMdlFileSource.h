...
class RbtMdlFileSource: public RbtBaseMolecularFileSource {
    public:
        ...
        RbtMdlFileSource(const RbtString& fileName, RbtBool bPosIonisable = true, RbtBool bNegIonisable = true,
    ...
    private:
        ...
        //
        // It is envisaged each molecular file source will have a version of SetupIonicGroups to convert from the
        // native representation to the rDock representation. The FormalCharge and PartialCharge attributes should be

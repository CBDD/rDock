...
class RbtBaseMolecularFileSource: public RbtBaseFileSource, public RbtBaseMolecularDataSource {
    public:
        // Constructors
        ...
        RbtBaseMolecularFileSource(const RbtString& fileName, const RbtString& strRecDelim,
    ...
    private:
        ...
        RbtBaseMolecularFileSource& operator=(
            const RbtBaseMolecularFileSource&);  // Copy assignment disabled by default

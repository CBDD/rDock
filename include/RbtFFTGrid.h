...
class RbtFFTPeak
{
 public:
  ...
  RbtCoord coord;//Location of peak maximum - real world vector/coord corresponding to displacement
...
class RbtFFTGrid : public RbtRealGrid
{
 public:
  ...
  RbtFFTGrid(const RbtCoord& gridMin, const RbtCoord& gridStep,

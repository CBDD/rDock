...
// Constructors
RbtGPFitnessFunction::RbtGPFitnessFunction(): m_rand(Rbt::GetRbtRand()), objective(0.0), fitness(0.0) {
...
RbtGPFitnessFunction& RbtGPFitnessFunction::operator=(const RbtGPFitnessFunction& g) {
    if (this != &g) {
        objective = g.objective;
        fitness = g.fitness;
    }

...
void ListAtoms(const RbtAtomList &atomList, RbtString strTitle, RbtInt nMaxToPrint = 20)
{
  ...
  cout << endl
       << "1st " << nToPrint << " " << strTitle << " (out of " << nSize << ")" << endl;
...
int main(int argc, char *argv[])
{
  ...
  {
    cout << endl
         << strExeName << " - output interaction center info for ligands in SD file (with optional autoionisation)" << endl;
    cout << endl
         << "Usage:\t" << strExeName << " -i<InputSDFile> [-o<OutputSDFile>] [-ap] [-an] [-allH]" << endl;
    cout << endl
         << "Options:\t-i<InputSDFile> - input ligand SD file" << endl;

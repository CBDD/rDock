...
RbtChromOccupancyRefData::~RbtChromOccupancyRefData() { _RBTOBJECTCOUNTER_DESTR_(_CT); }

RbtDouble RbtChromOccupancyRefData::GetModelValue() const { return (m_pModel) ? m_pModel->GetOccupancy() : 0.0; }

...
void RbtVdwIntraSF::SetupScore() {
    m_ligAtomList.clear();
    for (RbtAtomRListListIter iter = m_vdwIntns.begin(); iter != m_vdwIntns.end(); iter++) (*iter).clear();
    m_vdwIntns.clear();
    for (RbtAtomRListListIter iter = m_prtIntns.begin(); iter != m_prtIntns.end(); iter++) (*iter).clear();
    m_prtIntns.clear();

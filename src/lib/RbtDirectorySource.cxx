...
void RbtDirectorySource::CheckDirectory(RbtString& aDir) {
    //#ifdef COMENT
    if (!S_ISDIR(fStat.st_mode)) throw RbtDirIsNotAccessible(_WHERE_, aDir + " : Not a directory. ");
...
RbtDirectorySource::~RbtDirectorySource() { cout << "RbtDirectorySource destructor" << endl; }

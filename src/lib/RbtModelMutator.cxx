...
RbtModelMutator::~RbtModelMutator() { _RBTOBJECTCOUNTER_DESTR_("RbtModelMutator"); }

////////////////////////////////////////
// Public methods
////////////////

const RbtAtomRListList& RbtModelMutator::GetFlexIntns() const { return m_flexIntns; }

const RbtAtomRListList& RbtModelMutator::GetFlexAtoms() const { return m_rotAtoms; }

RbtBondList RbtModelMutator::GetFlexBonds() const { return m_rotBonds; }
...
void RbtModelMutator::Setup() {
    ...
    for (RbtBondListConstIter iter = m_rotBonds.begin(); iter != m_rotBonds.end(); iter++) {
        ...
        RbtInt nSelected = (nTethered == 0) ? Rbt::GetNumSelectedAtoms(m_pModel->m_atomList)
        ...
        for (RbtAtomRListConstIter sIter = sList.begin(); sIter != sList.end(); sIter++) {
            ...
            Assert<RbtAssert>(!MUT_CHECK || (id >= 0 && (RbtUInt)id < m_flexIntns.size()));

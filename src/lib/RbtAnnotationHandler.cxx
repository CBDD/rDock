...
RbtAnnotationHandler::RbtAnnotationHandler(): m_bEnabled(false) { _RBTOBJECTCOUNTER_CONSTR_("RbtAnnotationHandler"); }

RbtAnnotationHandler::~RbtAnnotationHandler() { _RBTOBJECTCOUNTER_DESTR_("RbtAnnotationHandler"); }
...
const RbtAnnotationList& RbtAnnotationHandler::GetAnnotationList() const { return m_annotationList; }

RbtInt RbtAnnotationHandler::GetNumAnnotations() const { return m_annotationList.size(); }
...
void RbtAnnotationHandler::ClearAnnotationList() const { m_annotationList.clear(); }

void RbtAnnotationHandler::EnableAnnotations(RbtBool bEnabled) const { m_bEnabled = bEnabled; }

...
// Default destructor
RbtBaseMolecularFileSink::~RbtBaseMolecularFileSink() { _RBTOBJECTCOUNTER_DESTR_("RbtBaseMolecularFileSink"); }
...
RbtModelList RbtBaseMolecularFileSink::GetSolvent() const { return m_solventList; }

void RbtBaseMolecularFileSink::SetSolvent(RbtModelList solventList) { m_solventList = solventList; }

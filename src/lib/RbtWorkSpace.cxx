...
void RbtWorkSpace::SetPopulation(RbtPopulationPtr population) { m_population = population; }
...
void RbtWorkSpace::SetDockingSite(RbtDockingSitePtr spDockSite) { m_spDockSite = spDockSite; }

...
RbtSiteMapper* RbtSiteMapperFactory::Create(const RbtString& strMapperClass,
...
RbtSiteMapper* RbtSiteMapperFactory::CreateFromFile(RbtParameterFileSourcePtr spPrmSource,
                                                    const RbtString& strName) throw(RbtError) {
